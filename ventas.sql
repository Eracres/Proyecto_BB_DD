...
DROP TABLE detalle_facturas cascade constraints; 
-- TABLA CLIENTES 
...
-- AGREGAR RELACIONES Y CLAVES PRIMARIAS
...
-- INSERTAR REGISTROS A TABLA FACTURAS
...
-- INSERTAR REGISTROS A LA TABLA DETALLE FACTURAS
